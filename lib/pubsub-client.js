    ...
    buster.captureServer.pubsubClient = {
        create: function (opts) {
            ...
            if (opts._fayeClient) {
                ...
                instance._serverBasicAuth   = opts.auth;
        ...
        _getFayeClientUrl: function() {
            var url = "http://";

            if(this._serverBasicAuth) {
                url += this._serverBasicAuth + '@';
            }

            url += this._serverHost + ":" + this._serverPort + "/messaging";
        ...
        _createFayeClient: function () {
            ...
            if(this._serverBasicAuth) {
                var auth = 'Basic ' + new Buffer(this._serverBasicAuth).toString('base64');
