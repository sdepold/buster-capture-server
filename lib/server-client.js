...
module.exports = {
    create: function (port, host, options) {
        ...
        for(var optionKey in options) {
            clientOptions[optionKey] = clientOptions[optionKey] || options[optionKey];
        }

        instance._pubsubClient = bCapServPubsubClient.create(clientOptions);
    ...
    _sessionToServer: function (serializedResourceSet, sessionOpts, deferred) {
        ...
        var req = this._request(opts, function (res, body) {
            try {
                ...
                console.log('response was no json :(')
                body = {}
            }
    ...
    _request: function (opts, cb) {
        ...
        var req = http.request(opts, function (res) {
            ...
            res.on("end", function () { console.log(body); cb(res, body); });
        });

        console.log('doing a request with ', req._headers)
