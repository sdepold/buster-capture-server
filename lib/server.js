...
module.exports = {
    ...
    _captureSlave: function (res, options) {
        options = options || {};

console.log('captureslave res headers', res._headers)
        var slave = bCapServSlave.create(this._resourceMiddleware, this._pubsubServer, options);
